...
class HomeCategoryLoadingShimmer extends StatefulWidget {
  final int? flex;
  final double? widthFactor;
  final double? height;

  HomeCategoryLoadingShimmer({
    super.key,
    this.flex,
    this.widthFactor,
    this.height,
  ...
  @override
  State<HomeCategoryLoadingShimmer> createState() =>
      _HomeCategoryLoadingShimmerState();
}

class _HomeCategoryLoadingShimmerState extends State<HomeCategoryLoadingShimmer>
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final double widthFactorValue =
              widget.widthFactor ?? 1.0; // Default to 1.0 if null
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ShimmerBox(
                          flex: flexValue, widthFactor: widthFactorValue),
                    ],
                  ),
                ),
