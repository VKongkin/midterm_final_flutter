  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          viewModel.postRequest.value.id != 0 ? Constants.UpdatePost.tr : Constants.CreatePost.tr,
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              viewModel.postRequest.value.id != 0 ? Constants.Update.tr : Constants.Create.tr,
              style: TextStyle(color: Colors.white),
            ),
          ),
          // TextButton(
                  ...
                  child: ListView(
                    ...
                    children: [
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage: CachedNetworkImageProvider(
                                "${ApiUrl.postGetImagePath}${viewModel.userImage}",
                              ),
                            ),
                            SizedBox(width: 10),
                            Expanded(
                      ...
                      Padding(
                        ...
                        child: TextField(
                          controller: viewModel.postTitleController.value,
                      ...
                      Padding(
                        ...
                        child: TextField(
                          ...
                          style: TextStyle(color: Colors.grey),
                          decoration: InputDecoration(
                            hintText: "Describe about your mind!",
                            hintStyle: TextStyle(color: Colors.grey),
                            border: InputBorder.none,
                          ),
                          maxLines: null,
